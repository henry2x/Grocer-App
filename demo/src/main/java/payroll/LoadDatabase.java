...
class LoadDatabase {
	...
	CommandLineRunner initDatabase(ManagerRepository ManagerRepository, OrderRepository orderRepository,
		...
		return args -> {
			...
			Address test = new Address("45 Overlea Blvd", "M4H 1C3", "Toronto");
			Manager m1 = new Manager("Lionel", "Messi");
			GroceryStore g1 = new GroceryStore(test, "Food Basics");
			 ...
			 * Manager m1 = new Manager("Jimmy", "Boi"); GroceryStore g1 = new
			 * GroceryStore(test, "Walmart"); groceryStoreRepository.save(g1); m1.setG(g1);
			 * 
			 * Manager m2 = new Manager("Sal", "Man"); Address test2 = new
			 * Address("101 Lawrence", "M3C 1B4", "Toronto"); GroceryStore g2 = new
			 * GroceryStore(test2, "Sobeys"); groceryStoreRepository.save(g2); m2.setG(g2);
			 * 
			 * Order o = new Order("Daily Bread Food Bank", Status.COMPLETED, new Date());
			 * o.setG(g2);
			 * 
			 * log.info("Preloading " + ManagerRepository.save(m1)); log.info("Preloading "
			 * + ManagerRepository.save(m2));
			 * 
			 * ManagerRepository.findAll().forEach(Manager -> log.info("Preloaded " +
			 * Manager));
			 * 
			 * orderRepository.save(o); //
			 * 
